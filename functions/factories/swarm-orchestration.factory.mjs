...
export class SwarmOrchestrationFactory extends OrchestrationAdapter {
    ...
    async functionsInstanceCreate(project) {
        return this.shell.exec([
            ...
            "--env \"MONGO_URL=mongodb://${appId}:${masterKey}@1.mongo.fahamutech.com:27017,2.mongo.fahamutech.com:27017,3.mongo.fahamutech.com:27017/${projectId}?authSource=admin&replicaSet=mdbRepl\"",
            "--env \"PORT=3000\"",
            "--env \"PRODUCTION=1\"",
    ...
    async databaseInstanceCreate(project) {
        return await this.shell.exec([
            ...
            "--env \"MOUNT_PATH=/\"",
            "--env \"S3_BUCKET=${cluster}-${bucketName}\"",
