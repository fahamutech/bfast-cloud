...
export function getBFastDatabaseConfigs() {
    ...
    return {
        ...
        rsaKeyPairInJson: envUtil.getEnv(process.env.RSA_KEY) ? envUtil.getEnv(process.env.RSA_KEY) : {},
        rsaPublicKeyInJson: envUtil.getEnv(process.env.RSA_PUBLIC_KEY) ? envUtil.getEnv(process.env.RSA_PUBLIC_KEY) : {},
