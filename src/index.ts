...
new BfastCloud({
    ...
    mongoURL: process.env.MONGO_URL ? process.env.MONGO_URL : 'mongodb://localhost:27017/_BFAST_ADMIN',
    mongoMasterURL: process.env.MONGO_MASTER_URL ? process.env.MONGO_MASTER_URL : 'mongodb://localhost:27017/_BFAST_ADMIN',
